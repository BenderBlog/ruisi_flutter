...
class _CaptchaDialogState extends State<CaptchaDialog> {
  ...
  Future<void> _loadCaptcha() async {
    ...
    setState(() {
      ...
      _loading = false;
      if (bytes == null) _captchaError = AppLocalizations.of(context)!.captchaLoadFailed;
    });
  }
  ...
  Future<void> _handleSubmit() async {
    ...
    if (ok) {
      ...
      setState(() {
        _submitting = false;
        _submitError = _c.loginError.value ?? AppLocalizations.of(context)!.loginFailed;
      });
      _captchaCtrl.clear();
      _loadCaptcha();
    }
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(AppLocalizations.of(context)!.loginCaptcha),
      content: Column(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: AppLocalizations.of(context)!.loginCaptchaHint,
